        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-foreground">
            <p className="text-lg leading-relaxed">
              <span className="font-semibold text-primary">RCA Speedcubing</span> proudly presents{" "}
            ...
            <p className="text-lg leading-relaxed">
              Organized by <span className="font-semibold text-primary">CubeX RVCE</span>,{" "}
              <span className="font-semibold text-primary">RVITM Cubing Association</span>, and{" "}
